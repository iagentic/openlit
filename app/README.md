# OpenLit FastAPI Server

This is the FastAPI backend server for OpenLit, providing authentication, database configuration management, and API key management.
